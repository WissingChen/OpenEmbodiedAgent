...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install OEA-ai[matrix]"
    ) from e

from OEA.bus.events import OutboundMessage
from OEA.bus.queue import MessageBus
from OEA.channels.base import BaseChannel
from OEA.config.paths import get_data_dir, get_media_dir
from OEA.utils.helpers import safe_filename
