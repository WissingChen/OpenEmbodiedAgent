...
def mock_prompt_session():
    ...
    with patch("OEA.cli.commands._PROMPT_SESSION", mock_session), \
         patch("OEA.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("OEA.cli.commands.PromptSession") as MockSession, \
         patch("OEA.cli.commands.FileHistory") as MockHistory, \
