...
def _make_loop():
    ...
    with patch("OEA.agent.loop.ContextBuilder"), \
         patch("OEA.agent.loop.SessionManager"), \
         patch("OEA.agent.loop.SubagentManager") as MockSubMgr:
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("OEA.agent.tools.registry.ToolRegistry.execute", fake_execute)
